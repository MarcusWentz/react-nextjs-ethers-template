...
export default function Home() {
  ...
  // const [providerRead, setProviderRead] = useState(null);
	// const [contractRead, setContractRead ] = useState(null);


  let providerRead; //Imported ethers from index.html with "<script src="https://cdn.ethers.io/lib/ethers-5.6.umd.min.js" type="text/javascript"></script>".
	let contractRead;
  ...
  //nextjs force client side execution for window object to be used to avoid errors.
  useEffect(() => {
    if(window.ethereum === undefined){
      alert("Metamask is not detected. Install Metamask then try again.");
      window.location.reload();
    ...
    if(window.ethereum !== undefined){
      // const tempProviderRead = new ethers.BrowserProvider(window.ethereum); //Imported ethers from index.html with "<script src="https://cdn.ethers.io/lib/ethers-5.6.umd.min.js" type="text/javascript"></script>".
      // const tempContractRead = new ethers.Contract(contractAddress, contractABI, providerRead);
      // console.log(tempProviderRead)
      // console.log(tempContractRead)
      // setProviderRead(tempProviderRead);
      // setContractRead(tempContractRead);
      providerRead = new ethers.BrowserProvider(window.ethereum); //Imported ethers from index.html with "<script src="https://cdn.ethers.io/lib/ethers-5.6.umd.min.js" type="text/javascript"></script>".
      contractRead = new ethers.Contract(contractAddress, contractABI, providerRead);
      console.log(providerRead)
